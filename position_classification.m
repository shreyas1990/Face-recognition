...
clear all;
Name = char('an2i','at33','boland','bpm', 'ch4f'); 
Position = char('left','right','straight','up');
...
%%% training the sample data and obtaining the weights %%%
[weightInputToHidden weightHiddenToOutput errorPlot] = train(Faces, oPosition, .01);
...
[op err a] = test(weightInputToHidden,weightHiddenToOutput,testFaces,oPosition);
